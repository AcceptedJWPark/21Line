...
public class Search_Business_Popup extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.tv_toolbarTitle)).setText("업종 선택 (4)");
        ...
        ((TextView)findViewById(R.id.tv_toolbarIcon_Right)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                elvAdapter = new Setbid_BusinessSelect_ELVAdapter(Search_Business_Popup.this,arrayList_Parent,arrayList_Child);
