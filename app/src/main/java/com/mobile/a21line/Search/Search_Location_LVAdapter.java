...
public class Search_Location_LVAdapter extends BaseExpandableListAdapter {
    ...
    public Search_Location_LVAdapter(Context context, ArrayList<BidUpCode.BidUpCodeItem> arrayParent, HashMap<BidUpCode.BidUpCodeItem,ArrayList<BidUpCode.BidUpCodeItem>> arrayChild)
    {
        super();
