...
import com.mobile.a21line.Setbid.Setbid_LVAdapter_Location;

import java.util.ArrayList;


public class Search_Location_Popup extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        copyLocationList();
        ((TextView) findViewById(R.id.tv_toolbarTitle)).setText("지역 선택 (4)");
