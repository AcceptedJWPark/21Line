...
public class Search_Business_LVAdapter extends BaseExpandableListAdapter {
    ...
    public Search_Business_LVAdapter(Context context, ArrayList<BidUpCode.BidUpCodeItem> arrayParent, HashMap<BidUpCode.BidUpCodeItem,ArrayList<BidUpCode.BidUpCodeItem>> arrayChild)
    {
        super();
